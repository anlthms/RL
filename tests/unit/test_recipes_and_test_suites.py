...
def test_nightly_compute_stays_below_3320_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 3320, (
        f"Total GPU hours exceeded 3320: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
