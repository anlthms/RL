...
def test_nightly_compute_stays_below_3730_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 3730, (
        f"Total GPU hours exceeded 3730: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
