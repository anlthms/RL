...
#
# Usage: SUBMIT_ACCOUNT=<account> bash launch_experiment.sh {colocated|non_colocated}
set -eu

MODE=${1:?"usage: bash launch_experiment.sh colocated|non_colocated"}
case "$MODE" in
